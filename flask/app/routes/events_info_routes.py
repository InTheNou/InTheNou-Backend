...
@app.route(route_prefix + "/App/Events/eid=<int:eid>/uid=<int:uid>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/CAT/timestamp=<string:timestamp>/uid=<int:uid>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/eid=<int:eid>/uid=<int:uid>/Follow", methods=['POST'])
...
@app.route(route_prefix + "/App/Events/eid=<int:eid>/uid=<int:uid>/Dismiss", methods=['POST'])
...
@app.route(route_prefix + "/App/Events/eid=<int:eid>/uid=<int:uid>/Unfollow", methods=['POST'])
...
@app.route(route_prefix + "/App/Events/eid=<int:eid>/uid=<int:uid>/estatus=<string:estatus>", methods=['POST'])
...
@app.route(route_prefix + "/App/Events/eid=<int:eid>/uid=<int:uid>/recommendstatus=<string:recommendstatus>", methods=['POST'])
...
@app.route(route_prefix + "/App/Events/Created/uid=<int:uid>/offset=<int:offset>/limit=<int:limit>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/Dismissed/uid=<int:uid>/offset=<int:offset>/limit=<int:limit>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/Following/uid=<int:uid>/offset=<int:offset>/limit=<int:limit>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/General/uid=<int:uid>/offset=<int:offset>/limit=<int:limit>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/General/search=<string:searchstring>/offset=<int:offset>/limit=<int:limit>/uid=<int:uid>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/History/uid=<int:uid>/offset=<int:offset>/limit=<int:limit>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/Recommended/uid=<int:uid>/offset=<int:offset>/limit=<int:limit>", methods=['GET'])
...
@app.route(route_prefix + "/App/Events/Recommended/search=<string:searchstring>/offset=<int:offset>/limit=<int:limit>/uid=<int:uid>", methods=['GET'])
# Make this with session!
...
@app.route(route_prefix + "/App/Tags/uid=<int:uid>", methods=['GET'])
